...
const TopHomeRightSideComponent = () => {
  ...
  return (
    <div className="flex flex-col h-[38vh] md:h-[50vh] lg:h-[50vh] justify-center items-center py-4 px-2 gap-2">
      <p className="uppercase text-[8px] text-black-1 bg-teal-300 rounded-md px-2 py-1">
        New
      </p>
      <p className="capitalize text-[10px] md:text-[12px] lg:text-[12px] text-white-1 pt-1">
        Get Suggested AI Domains
      </p>
      <p className="capitalize text-md md:text-xl lg:text-xl text-white-1 text-center font-extrabold py-4">
