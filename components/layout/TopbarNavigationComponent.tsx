...
const TopbarNavigationComponent = () => {
    ...
    return (
        <nav
            className={`fixed w-full z-20 ${scrolled ? "bg-gray-3" : "bg-transparent"
        ...
        >
            ...
            <div
                className={`sm:hidden bg-gray-4 fixed top-0 right-0 h-full w-1/2 transform ${isOpen ? "translate-x-0" : "translate-x-full"
